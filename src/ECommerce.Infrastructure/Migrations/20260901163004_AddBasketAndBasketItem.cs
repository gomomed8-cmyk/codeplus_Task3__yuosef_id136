...
namespace ECommerce.Infrastructure.Migrations
{
    ...
    public partial class AddBasketAndBasketItem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "Id", "Amount", "OrderId", "PaymentDate", "Status", "TransactionReference" },
                values: new object[] { 1, 191.28m, 1, new DateTime(2026, 1, 15, 10, 35, 0, 0, DateTimeKind.Utc), 1, "TX-REF-10001" });
